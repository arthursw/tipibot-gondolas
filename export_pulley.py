...
parser = argparse.ArgumentParser(description='Export pulley.')
...
for kerf_width in kerf_widths:
    ...
    output_folder = Path(f'pulley_parts{kerf_string}_{export_command}')
    ...
    for part in parts:
        ...
        command += [f'-Dpart="{part}"', f'-Dkerf_width={kerf_width}', 'pulley.scad']
